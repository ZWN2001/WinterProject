...
class Bubble extends StatelessWidget {
  ...
  this.borderRadius,
  this.child, this.decoration, this.padding, this.margin, this.constraints, this.width,this.height,this.alignment, this.color})
...
class _BubbleCliper extends CustomClipper<Path> {
  final BubbleDirection direction;
  final Radius radius;
  _BubbleCliper(this.direction, this.radius);
